...
namespace wr
{
	...
	REGISTER(pipelines::basic_deferred, PipelineRegistry)<VertexColor>({
		...
		PipelineDescription::RTVFormats({ Format::R32G32B32A32_FLOAT, Format::R32G32B32A32_FLOAT, Format::R32G32B32A32_FLOAT, Format::R32G32B32A32_FLOAT,  Format::R32G32B32A32_FLOAT, Format::R32G32B32A32_FLOAT }),
		PipelineDescription::NumRTVFormats(6),
	...
	REGISTER(state_objects::rt_hybrid_state_object, RTPipelineRegistry)(
	{
		...
		StateObjectDescription::MaxPayloadSize(sizeof(float) * 8 + sizeof(unsigned int) * 1),
