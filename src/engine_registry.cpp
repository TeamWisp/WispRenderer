...
namespace wr
{
	...
	std::vector<CD3DX12_DESCRIPTOR_RANGE> r = {
		...
		[] { CD3DX12_DESCRIPTOR_RANGE r; r.Init(D3D12_DESCRIPTOR_RANGE_TYPE::D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 5, 25); return r; }(),
	};
	...
	std::vector<CD3DX12_DESCRIPTOR_RANGE> rt_hybrid_ranges = {
		...
		[] { CD3DX12_DESCRIPTOR_RANGE r; r.Init(D3D12_DESCRIPTOR_RANGE_TYPE::D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 3, d3d12::settings::hybrid_g_buffer_offset); return r; }(),
