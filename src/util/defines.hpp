...
decltype(wr::SceneGraph::m_init_lights_func_impl) wr::SceneGraph::m_init_lights_func_impl = [](wr::RenderSystem* render_system, std::vector<std::shared_ptr<wr::LightNode>>& nodes) \
{ \
	static_cast<renderer_type*>(render_system)->function(nodes); \
};
...
decltype(wr::SceneGraph::m_update_lights_func_impl) wr::SceneGraph::m_update_lights_func_impl = [](wr::RenderSystem* render_system, std::vector<std::shared_ptr<wr::LightNode>>& nodes, wr::CommandList* cmd_list) \
{ \
	static_cast<renderer_type*>(render_system)->function(nodes, cmd_list); \
};