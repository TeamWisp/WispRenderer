...
decltype(wr::SceneGraph::m_update_lights_func_impl) wr::SceneGraph::m_update_lights_func_impl = [](wr::RenderSystem* render_system, wr::SceneGraph& scene_graph, wr::CommandList* cmd_list) \
{ \
	static_cast<renderer_type*>(render_system)->function(scene_graph, cmd_list); \
};