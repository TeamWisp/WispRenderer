...
namespace ImGui
{
    ...
    IMGUI_API ImGuiID       DockSpaceOverViewport(bool has_main_menu_bar = false, ImGuiViewport* viewport = NULL, ImGuiDockNodeFlags dockspace_flags = 0, const ImGuiDockFamily* dock_family = NULL);
...
struct ImGuiTextFilter
{
	...
	IMGUI_API void      SetInputFilter(const char* filter = "");
