...
ImGuiID ImGui::DockSpaceOverViewport(bool has_main_menu_bar, ImGuiViewport* viewport, ImGuiDockNodeFlags dockspace_flags, const ImGuiDockFamily* dock_family)
{
    if (viewport == NULL)
...
#if defined(_WIN32) && !defined(USE_UWP) && !defined(IMGUI_DISABLE_WIN32_FUNCTIONS) && !defined(IMGUI_DISABLE_WIN32_DEFAULT_CLIPBOARD_FUNCTIONS)
