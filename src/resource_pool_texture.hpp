...
namespace wr
{
	...
	public:
		...
		[[nodiscard]] virtual TextureHandle LoadFromCompressedMemory(unsigned char* data, size_t width, size_t height, TextureFormat type, bool srgb, bool generate_mips) = 0;
