...
namespace viknell_scene
{
	...
	{
		camera = scene_graph->CreateChild<DebugCamera>(nullptr, 80.f, (float) window->GetWidth() / (float) window->GetHeight());
		...
		auto right_wall = scene_graph->CreateChild<wr::MeshNode>(nullptr, resources::mirror_plane_model);
